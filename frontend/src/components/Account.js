...
const Account = ({toggleDisplayAccount}) => {
    ...
    const editName = () => {
        ...
        name_input.onblur = async (e) => {
            ...
            if(newName.length === 0 || typeof newName === undefined){
                ...
                await fetch(`https://blog-io.vercel.app/edit?field=name&value=${encodeURI(newName)}`)
    ...
    const editBio = () => {
        ...
        bio_input.onblur = async (e) => {
            ...
            await fetch(`https://blog-io.vercel.app/edit?field=bio&value=${encodeURI(newBio)}`)
